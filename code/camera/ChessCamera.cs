namespace Chess
{
	...
	public class ChessCamera : Camera
	{
		...
		Vector3[] positions = new Vector3[3] { new Vector3( -800f, 0f, 2000f ) , new Vector3( -1000f, 0f, 2100f ), new Vector3( -10f, 0f, 2400f ) };
		...
		public override void Update()
		{
			...
			var targetDelta = (new Vector3( 0f, 0f, 1200f ) - Position);
