namespace Chess
{
	...
	public class ChessCamera : Camera
	{
		...
		Vector3[] positions = new Vector3[3] { new Vector3( -800f, 0f, 700f ) , new Vector3( -1000f, 0f, 800f ), new Vector3( -10f, 0f, 1100f ) };
		...
		public override void Update()
		{
			...
			var targetDelta = (new Vector3( 0f, 0f, 0f ) - Position);
